...
@push('after-script')
    ...
    // tampilkan data pembobotan berdasarkan kriteria pertable
    // ajax: {
    //     url: "{{ route('subkriteria.index') }}",
    //     data: function (d) {
    ...
    columns: [
        ...
        // ambil data kode alternatif dari table alternatif
        {data: 'alternatif.kode_alternatif', name: 'alternatif.kode_alternatif'},
        {data: 'C1', name: 'C1'},
        {data: 'C2', name: 'C2'},
        {data: 'C3', name: 'C3'},
        {data: 'C4', name: 'C4'},
